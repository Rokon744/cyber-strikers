...
import { Shield, Trophy, Swords, MapPin, Calendar, ChevronRight, Zap, Target, Star } from "lucide-react";
import Link from "next/link";
import Countdown from "@/components/Countdown";
import { teamInfo, upcomingMatch } from "@/data/data";
    ...
    <div className="min-h-screen bg-grid bg-dark-base">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(0,255,231,0.8) 0%, transparent 70%)", filter: "blur(60px)" }}
          />
          <div
            className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full opacity-5"
            style={{ background: "radial-gradient(circle, rgba(0,150,255,0.8) 0%, transparent 70%)", filter: "blur(40px)" }}
          />
        </div>
            ...
            <motion.div variants={fadeUp} className="mb-4">
              ...
              >
                ...
                <span
                  ...
                  style={{ textShadow: "0 0 30px rgba(0,255,231,0.5), 0 0 80px rgba(0,255,231,0.2)" }}
                >
                  STRIKERS
                </span>
              </h1>
            ...
            >
              {[
                ...
                <div key={label} className="text-center">
                  <Icon size={18} className="text-neon mx-auto mb-2 opacity-70" />
                  <p className="font-display font-bold text-3xl sm:text-4xl text-white">{value}</p>
                  <p className="text-xs text-slate-500 tracking-widest mt-1">{label}</p>
                </div>
              ))}
            </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <p className="text-xs text-neon tracking-[0.4em] mb-3 font-body">NEXT BATTLE</p>
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-dark-border">
              <span className="text-xs text-slate-500 tracking-widest font-body">{upcomingMatch.tournament}</span>
              <span className="text-xs px-3 py-1 border border-neon/30 text-neon font-body tracking-widest">{upcomingMatch.round}</span>
            </div>
            ...
            <div className="grid grid-cols-3 items-center py-12 px-6">
              ...
              <div className="text-center">
                ...
                >
                  <Image src={upcomingMatch.teamAlogo} alt="team a logo" className="w-[100px] h-[100px] object-cover" />
              ...
              <div className="text-center">
                <div className="relative">
                  ...
                  <p className="text-xs text-slate-600 tracking-[0.3em] mt-2">BATTLE</p>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                >
                  <Image src={upcomingMatch.teamBlogo} alt="team b logo" className="w-[100px] h-[100px] object-cover" />
                  <Shield size={32} className="text-slate-400" />
                </div>
                <h3 className="font-display font-bold text-xl sm:text-2xl text-white tracking-wider">
                  {upcomingMatch.teamB}
                </h3>
                <p className="text-xs text-slate-500 mt-1 tracking-widest">AWAY</p>
              </div>
            </div>
          ...
          >
            <p className="text-xs text-slate-500 tracking-[0.4em] font-body">MATCH STARTS IN</p>
      ...
      <section className="py-24 px-4 sm:px-6 border-t border-dark-border">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {/* Text */}
            <div>
              <p className="text-xs text-neon tracking-[0.4em] mb-4 font-body">ABOUT US</p>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-4 font-body">
                Cyber Strikers is not just a cricket team — it&apos;s a movement. Founded in 2023,
                we bring together Dhaka&apos;s sharpest players under one banner to compete with
                fearless energy and tactical precision.
              </p>
              <p className="text-slate-400 text-sm leading-relaxed mb-8 font-body">
                Our philosophy: analyze the field like a computer, strike like lightning. Every
                match is a system to crack, every opponent is a puzzle to solve.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Star, label: "Captain", value: teamInfo.captain },
                  { icon: MapPin, label: "Home Ground", value: teamInfo.homeGround },
                  { icon: Calendar, label: "Founded", value: teamInfo.founded },
                  { icon: Trophy, label: "Trophies Won", value: `${teamInfo.trophies} Cups` },
                  ...
                  >
                    ...
                    <p className="font-display font-semibold text-white text-sm tracking-wider">{value}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative hidden md:flex items-center justify-center">
              ...
              <div className="absolute text-center -rotate-0">
                <Image src={cyber_strikers} alt="logo" className="w-10/12 m-auto" />
